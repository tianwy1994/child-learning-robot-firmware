...
// ServerCallbacks 实现
void BleServer::ServerCallbacks::onConnect(NimBLEServer* pServer) {
    Serial.println("[BLE] 设备已连接");
    _parent->_advertising = false;
}

void BleServer::ServerCallbacks::onDisconnect(NimBLEServer* pServer) {
...
// TokenCallbacks 实现
void BleServer::TokenCallbacks::onWrite(NimBLECharacteristic* pCharacteristic) {
